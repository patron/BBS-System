...
if ($this->session->userdata("role") == "Bbsadmin") {
    echo '<li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Bbsadmin Menu</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="' . base_url() . 'index.php/bbsadmin/userlist"><i class="icon fa fa-circle-o"></i>Bbsuser List</a></li>
...
elseif ($this->session->userdata("role") == "Bbsuser"){
    echo '<li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Bbsuser Menu</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
